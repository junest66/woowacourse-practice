...
public class Values {
    public static final String CHRISTMAS_EVENT_NAME = "크리스마스 디데이 할인";
    public static final String WEEKDAY_EVENT_NAME = "평일 할인";
    public static final String WEEKEND_EVENT_NAME = "주말 할인";
    public static final String GIVEAWAY_EVENT_NAME = "증정 이벤트";
    public static final String SPECIAL_EVENT_NAME = "특별 할인";
    ...
    public static final int TBONE_STEAK_PRICE = 55000;
